...
class LaserOffsetFine extends StatelessWidget {
  final LaserPageController controller;
  const LaserOffsetFine({super.key, required this.controller});
      ...
      child: Row(
        ...
        children: [
          Container(
              ...
              child: Text("Offset\nfine:")),
          for (int p = 0; p < controller.offsetfine.length; p++)
            Expanded(
                flex: 1,
                child: Container(
                    margin: EdgeInsets.symmetric(horizontal: 2),
                    child: LaserNumericPadInput(
                      ...
                      controller: controller.offsetfineController[p],
                    ))),
        ],
      ),
    );
